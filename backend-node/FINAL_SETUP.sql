...
('National Pension Scheme', 'Retirement savings for all citizens', 18, 65, NULL, NULL, NULL, NULL, NULL, 'Pension', NULL, NULL, 'Monthly upon retirement', '["Aadhaar Card", "PAN Card", "Bank Details"]'::jsonb);
